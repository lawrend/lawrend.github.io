...
After eight Players write Lines the Payam is completed and all Lines can be read. The Payam is listed with all other c
completed Payams of its Style, and anyone can read them.
